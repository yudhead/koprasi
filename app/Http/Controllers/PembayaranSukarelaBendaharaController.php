...
class PembayaranSukarelaBendaharaController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutBendahara.pembayaran-sukarela', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('BendaharaSukarela.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
