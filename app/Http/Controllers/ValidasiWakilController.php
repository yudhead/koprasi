...
class ValidasiWakilController extends Controller
{
    ...
    public function showValidationPage()
    {
        ...
        return view('LayoutWakil.validasi', compact('peminjamans'));
    }
    ...
    public function processValidation(Request $request)
{
    ...
    return redirect()->route('wakil_ketua.validasi')->with('success', 'Status peminjaman berhasil diperbarui.');
}
}
