...
class PeminjamanWakilController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('wakil_ketua.peminjaman.index')->with('success', 'Peminjaman berhasil ditambahkan');
    }

    public function edit($id)
    {
        $peminjaman = Peminjaman::findOrFail($id);
        return view('LayoutWakil.peminjaman-edit', compact('peminjaman'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('wakil_ketua.peminjaman.index')->with('success', 'Peminjaman berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('wakil_ketua.peminjaman.index')->with('success', 'Peminjaman berhasil dihapus');
    }
}
