...
class PembayaranAnggotaController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutAnggota.pembayaran-angsuran', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('PembayaranAngsuran.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
