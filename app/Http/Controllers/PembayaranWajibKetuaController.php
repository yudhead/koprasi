...
class PembayaranWajibKetuaController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutKetua.pembayaran-wajib', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('KetuaWajib.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
