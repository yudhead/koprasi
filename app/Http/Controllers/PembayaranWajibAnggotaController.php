...
class PembayaranWajibAnggotaController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutAnggota.pembayaran-angsuran-wajib', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('PembayaranWajib.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
