...
class PembayaranWajibWakilController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutWakil.pembayaran-wajib', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('WakilWajib.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
