...
class PembayaranSukarelaWakilController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutWakil.pembayaran-sukarela', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('WakilSukarela.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
