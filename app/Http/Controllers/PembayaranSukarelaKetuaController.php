...
class PembayaranSukarelaKetuaController extends Controller
{
    public function index()
    {
        ...
        return view('LayoutKetua.pembayaran-sukarela', compact('peminjamans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('KetuaSukarela.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
