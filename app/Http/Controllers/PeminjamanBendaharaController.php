...
class PeminjamanBendaharaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bendahara.peminjaman.index')->with('success', 'Peminjaman berhasil ditambahkan');
    }

    public function edit($id)
    {
        $peminjaman = Peminjaman::findOrFail($id);
        return view('LayoutBendahara.peminjaman-edit', compact('peminjaman'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('bendahara.peminjaman.index')->with('success', 'Peminjaman berhasil diperbarui');
    }
