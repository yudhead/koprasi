        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('wakil_ketua.peminjaman.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                    <a href="{{ route('wakil_ketua.peminjaman.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
                                </button>
                                </div>
